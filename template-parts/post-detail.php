...
<div class="post-detail--avatar-wrapper">
    <div class="post-detail--avatar-name">verfasst von <?php echo the_author_meta('first_name'); ?></div>
    <div class="post-detail--date"><?php the_time(get_option('date_format')); ?></div>
</div>
<?php
